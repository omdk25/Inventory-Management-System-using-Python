...
class Application():
    def __init__(self,master,*args,**kwargs):
        ...
        self.left=Frame(master,width=900,height=768,bg='black')
        self.left.pack(side=LEFT)

        self.right = Frame(master, width=666, height=768, bg='black')
        self.right.pack(side=RIGHT)


        #components
        self.heading=Label(self.left,text="GADA ELECTRONICS",font=('arial 40 bold'),fg='white',bg='black')
        self.heading.place(x=0,y=0)

        self.date_l=Label(self.right,text="Today's Date: "+str(date),font=('arial 16 bold'),bg='black',fg='white')
        self.date_l.place(x=0,y=0)

        #table invoice=======================================================
        self.tproduct=Label(self.right,text="Products",font=('arial 18 bold'),bg='black',fg='white')
        self.tproduct.place(x=0,y=60)

        self.tquantity = Label(self.right, text="Quantity", font=('arial 18 bold'), bg='black', fg='white')
        self.tquantity.place(x=300, y=60)

        self.tamount = Label(self.right, text="Amount", font=('arial 18 bold'), bg='black', fg='white')
    ...
    def ajax(self,*args,**kwargs):
        ...
        #geneerate bill button
          self.bill_btn = Button(self.left, text="Generate Bill", width=50, height=2, bg='red',fg='white',command=self.generate_bill)
          self.bill_btn.place(x=150, y=640)
        else:
    ...
    def add_to_cart(self,*args,**kwargs):
        ...
        if  self .quantity_value >int(self.get_stock):
            ...
            for self.p in products_list:
                ...
                #total confugure
                self.total_l.configure(text="Total : Rs. "+str(sum(product_price)),bg='black',fg='orange')
                #delete
